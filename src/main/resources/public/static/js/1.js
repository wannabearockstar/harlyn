...
(function( $ ){
  function t_initZoom(){
    if ( $('[data-zoomable="yes"]').length ) {    
      ...
      $('body').append("<div class=\"t-zoomer__wrapper\"><div class=\"t-zoomer__container\"><img class=\"t-zoomer__img\" src=\"data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7\ \"></div><div class=\"t-zoomer__descr t-descr t-descr_xs\"></div><div class=\"t-zoomer__bg\"></div></div>");
      t_showZoom();
